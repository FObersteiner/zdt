...
test "conversion between random time zones" {
    var tz_a = try Tz.fromTzdata("Canada/Pacific", std.testing.allocator);
    var tz_b = try Tz.fromTzdata("America/Thule", std.testing.allocator);
    ...
    try testing.expectEqualStrings("2030-11-23T19:52:41-08:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1944-02-19T23:44:41-04:00:00", s_c.items);
    ...
    tz_a = try Tz.fromTzdata("Asia/Makassar", std.testing.allocator);
    tz_b = try Tz.fromTzdata("Etc/GMT-14", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1909-12-30T02:53:58+07:57:36", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("2031-07-18T18:14:16+14:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("Canada/Eastern", std.testing.allocator);
    tz_b = try Tz.fromTzdata("NZ", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("2008-10-03T04:05:31-04:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1934-04-03T15:15:42+12:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("Africa/Blantyre", std.testing.allocator);
    ...
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1954-08-09T08:09:04-04:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("Asia/Karachi", std.testing.allocator);
    tz_b = try Tz.fromTzdata("Canada/Eastern", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1992-10-14T14:44:14+05:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1938-04-30T06:59:52-04:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("America/Nome", std.testing.allocator);
    tz_b = try Tz.fromTzdata("Pacific/Honolulu", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1963-10-24T21:19:31-11:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1925-12-20T15:21:33-10:30:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("America/Kentucky/Louisville", std.testing.allocator);
    tz_b = try Tz.fromTzdata("Etc/GMT-10", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1929-12-29T03:14:40-06:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1995-03-02T12:35:13+10:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("Asia/Phnom_Penh", std.testing.allocator);
    tz_b = try Tz.fromTzdata("Asia/Aqtobe", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1981-07-22T03:43:20+07:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1911-07-02T09:31:38+03:48:40", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("Asia/Ashkhabad", std.testing.allocator);
    tz_b = try Tz.fromTzdata("US/Alaska", std.testing.allocator);
    ...
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("2032-05-04T15:40:56-08:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("Asia/Vientiane", std.testing.allocator);
    tz_b = try Tz.fromTzdata("America/Argentina/Salta", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1949-09-27T21:59:08+07:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    ...
    tz_a = try Tz.fromTzdata("Asia/Katmandu", std.testing.allocator);
    tz_b = try Tz.fromTzdata("Europe/Oslo", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1945-03-21T09:29:24+05:30:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1920-03-10T09:12:15+01:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("America/Indiana/Winamac", std.testing.allocator);
    tz_b = try Tz.fromTzdata("Asia/Katmandu", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("2001-03-31T21:21:55-05:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1921-12-11T16:38:20+05:30:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("Etc/GMT-3", std.testing.allocator);
    tz_b = try Tz.fromTzdata("America/Louisville", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1954-07-24T03:42:40+03:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1931-07-01T00:18:06-06:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("Australia/Tasmania", std.testing.allocator);
    tz_b = try Tz.fromTzdata("Asia/Ashgabat", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1923-04-29T04:03:38+10:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("2013-05-03T21:32:02+05:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("Atlantic/Madeira", std.testing.allocator);
    tz_b = try Tz.fromTzdata("Pacific/Rarotonga", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1922-02-02T10:33:17-01:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1961-09-29T21:13:05-10:30:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("Pacific/Guadalcanal", std.testing.allocator);
    tz_b = try Tz.fromTzdata("Asia/Ust-Nera", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1985-02-13T18:16:25+11:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1996-02-12T17:07:41+11:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("Australia/Yancowinna", std.testing.allocator);
    tz_b = try Tz.fromTzdata("Etc/GMT-8", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1906-01-27T09:28:00+09:30:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1955-11-27T12:46:31+08:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("Africa/Luanda", std.testing.allocator);
    tz_b = try Tz.fromTzdata("Europe/Warsaw", std.testing.allocator);
    ...
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("2035-12-12T00:49:12+01:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("US/Central", std.testing.allocator);
    tz_b = try Tz.fromTzdata("America/Lower_Princes", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1991-12-24T18:37:50-06:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("2025-07-01T07:23:03-04:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("Antarctica/Rothera", std.testing.allocator);
    tz_b = try Tz.fromTzdata("Australia/Eucla", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1958-03-06T20:58:39+00:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1992-09-07T18:22:52+08:45:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();
    ...
    tz_b = try Tz.fromTzdata("Asia/Pontianak", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1924-03-14T17:29:45+10:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1960-09-18T20:14:11+07:30:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("PST8PDT", std.testing.allocator);
    tz_b = try Tz.fromTzdata("Asia/Chungking", std.testing.allocator);
    ...
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1987-10-06T10:18:03+08:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("Indian/Kerguelen", std.testing.allocator);
    tz_b = try Tz.fromTzdata("America/Thunder_Bay", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1988-05-15T01:22:19+05:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1937-12-27T09:04:54-05:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("America/Argentina/Rio_Gallegos", std.testing.allocator);
    tz_b = try Tz.fromTzdata("US/East-Indiana", std.testing.allocator);
    ...
    tz_a = try Tz.fromTzdata("Pacific/Guadalcanal", std.testing.allocator);
    tz_b = try Tz.fromTzdata("America/Catamarca", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1994-08-04T21:00:53+11:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("2004-09-09T13:58:02-03:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();

    tz_a = try Tz.fromTzdata("Pacific/Kiritimati", std.testing.allocator);
    tz_b = try Tz.fromTzdata("Australia/Canberra", std.testing.allocator);
    ...
    dt_b = try dt_b.tzConvert(.{ .tz = &tz_a });
    try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
    try testing.expectEqualStrings("1995-01-01T17:46:53+14:00:00", s_b.items);
    try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
    try testing.expectEqualStrings("1968-08-01T23:47:32+10:00:00", s_c.items);
    tz_a.deinit();
    tz_b.deinit();
    s_b.clearAndFree();
    s_c.clearAndFree();
