...
//     tz_b = try Tz.fromTzfile("America/Tijuana", std.testing.allocator);
...
//     try testing.expectEqualStrings("1925-12-02T00:06:14-04:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1917-03-03T15:01:55-07:48:04", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("Africa/Blantyre", std.testing.allocator);
//     tz_b = try Tz.fromTzfile("Etc/GMT-7", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1956-08-13T14:49:58+02:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1933-11-17T23:12:01+07:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
...
//     tz_b = try Tz.fromTzfile("Pacific/Niue", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("2022-11-23T15:50:32+03:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1976-05-31T20:53:53-11:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("America/Swift_Current", std.testing.allocator);
//     tz_b = try Tz.fromTzfile("Indian/Christmas", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1987-06-19T22:22:54-06:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1988-04-07T20:32:04+07:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("GMT-0", std.testing.allocator);
//     tz_b = try Tz.fromTzfile("Europe/Tallinn", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("2012-10-01T15:14:19+00:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1916-09-03T14:42:36+01:39:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("Pacific/Tarawa", std.testing.allocator);
//     tz_b = try Tz.fromTzfile("Asia/Harbin", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1934-05-23T11:27:13+12:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("2030-09-20T18:09:16+08:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("Australia/Darwin", std.testing.allocator);
//     tz_b = try Tz.fromTzfile("Africa/Brazzaville", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1930-06-19T23:56:21+09:30:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1909-01-27T19:20:35+00:13:35", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("Asia/Chita", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("2013-03-19T21:49:09+10:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1945-09-02T20:18:38+02:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("Australia/Victoria", std.testing.allocator);
//     tz_b = try Tz.fromTzfile("Europe/London", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1979-02-13T12:53:29+11:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("2022-05-28T13:00:48+01:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("Antarctica/McMurdo", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1955-08-30T19:48:45+12:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1991-02-09T21:54:48-05:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
...
//     tz_b = try Tz.fromTzfile("Europe/Amsterdam", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1966-08-18T12:11:05-11:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1922-03-13T19:23:11+00:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("Europe/Saratov", std.testing.allocator);
//     tz_b = try Tz.fromTzfile("America/Bahia_Banderas", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1985-12-22T19:26:45+04:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("2032-11-18T23:25:46-06:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("America/Los_Angeles", std.testing.allocator);
//     tz_b = try Tz.fromTzfile("Asia/Kabul", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("2033-04-14T15:55:29-07:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1928-03-06T12:16:26+04:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("Africa/Juba", std.testing.allocator);
//     tz_b = try Tz.fromTzfile("Navajo", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1908-01-08T19:16:04+02:06:28", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1997-07-27T00:55:22-06:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("Etc/GMT+2", std.testing.allocator);
//     tz_b = try Tz.fromTzfile("Indian/Cocos", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1994-03-14T03:18:23-02:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1954-09-07T21:27:46+06:30:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("Antarctica/Syowa", std.testing.allocator);
//     tz_b = try Tz.fromTzfile("Antarctica/Mawson", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1917-03-22T11:03:54+03:06:52", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1973-03-22T18:21:18+06:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("America/Port_of_Spain", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1965-11-15T20:26:57-04:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1944-07-03T12:45:40+11:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("Europe/San_Marino", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1948-07-02T02:14:09+02:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1960-06-09T09:17:08-03:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
...
//     tz_b = try Tz.fromTzfile("Atlantic/Faeroe", std.testing.allocator);
...
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1940-01-05T15:55:52+00:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("MET", std.testing.allocator);
//     tz_b = try Tz.fromTzfile("Indian/Kerguelen", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1929-01-12T16:29:37+00:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("2024-06-20T18:00:49+05:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("US/Central", std.testing.allocator);
//     tz_b = try Tz.fromTzfile("Asia/Dili", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1943-02-13T08:50:12-05:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1991-04-15T04:07:07+08:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("America/Rainy_River", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1902-11-08T22:38:51-06:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("2000-11-06T04:39:53+03:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("Asia/Ulaanbaatar", std.testing.allocator);
//     tz_b = try Tz.fromTzfile("Africa/Sao_Tome", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("2022-03-18T19:25:53+08:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("2020-05-02T07:21:04+00:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
//
//     tz_a = try Tz.fromTzfile("America/Argentina/Salta", std.testing.allocator);
//     tz_b = try Tz.fromTzfile("Australia/Lord_Howe", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1946-11-14T23:14:52-03:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1946-09-03T16:47:40+10:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
...
//     tz_b = try Tz.fromTzfile("Europe/Copenhagen", std.testing.allocator);
...
//     dt_b = try dt_b.tzConvert(tz_a);
//     try dt_b.toString("%Y-%m-%dT%H:%M:%S%::z", s_b.writer());
//     try testing.expectEqualStrings("1935-12-08T13:59:56+07:00:00", s_b.items);
//     try dt_c.toString("%Y-%m-%dT%H:%M:%S%::z", s_c.writer());
//     try testing.expectEqualStrings("1984-04-18T21:15:46+02:00:00", s_c.items);
//     tz_a.deinit();
//     tz_b.deinit();
//     s_b.clearAndFree();
//     s_c.clearAndFree();
